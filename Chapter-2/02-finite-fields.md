...
multiplication, and division are all defined. For prime p, the field F_p is the integers
{0, 1, ..., p-1} with arithmetic done modulo p. Prime modulus is essential because every
nonzero element has a multiplicative inverse.

This is like clock arithmetic: on a 12-hour clock, 9 + 6 = 3 (mod 12). For cryptography,
